          ...
          <div class="panel panel-default">
            ...
            <div class="row">
              <div
                ...
                class="col-md-6"
              >
                <form class="js-validation-signup" @submit.prevent="store">
                  <div class="py-3">
                    <div class="form-group">
                      <input
                        ...
                        type="text"
                        placeholder="name"
                        @keydown="creating.form.errors.clear('name')"
                      />
                      <span
                        v-if="
                          !$v.creating.form.name.required &&
                          $v.creating.form.name.$dirty
                        "
                        class="text-danger"
                      ...
                      <span
                        v-else-if="
                          !$v.creating.form.name.maxLength &&
                          $v.creating.form.name.$dirty
                        "
                        class="text-danger"
                      ...
                      <span
                        v-else-if="
                          !$v.creating.form.name.minLength &&
                          $v.creating.form.name.$dirty
                        "
                        class="text-danger"
                      ...
                      <span
                        v-if="creating.form.errors.has('name')"
                        class="text-danger"
                        v-text="creating.form.errors.get('name')"
                      />
                    </div>

                    <div class="form-group">
                      <input
                        v-model="creating.form.email"
                        class="form-control form-control-lg form-control-alt"
                        type="email"
                        placeholder="Email"
                        @keydown="creating.form.errors.clear('email')"
                      />
                      <span
                        v-if="
                          !$v.creating.form.email.required &&
                          $v.creating.form.email.$dirty
                        "
                        class="text-danger"
                      ...
                      <span
                        v-else-if="
                          !$v.creating.form.email.maxLength &&
                          $v.creating.form.email.$dirty
                        "
                        class="text-danger"
                      ...
                      <span
                        v-else-if="
                          !$v.creating.form.email.minLength &&
                          $v.creating.form.email.$dirty
                        "
                        class="text-danger"
                      ...
                      >
                      <span
                        v-if="creating.form.errors.has('email')"
                        class="text-danger"
                        v-text="creating.form.errors.get('email')"
                      />
                    </div>
                    <div class="form-group">
                      <input
                        ...
                        @keydown="creating.form.errors.clear('password')"
                      />
                      <span
                        v-if="
                          !$v.creating.form.password.required &&
                          $v.creating.form.password.$dirty
                        "
                        class="text-danger"
                      ...
                      <span
                        v-else-if="
                          !$v.creating.form.password.minLength &&
                          $v.creating.form.password.$dirty
                        "
                        class="text-danger"
                        >The password length should be atleast 6
                        characters</span
                      >
                      <span
                        v-if="creating.form.errors.has('password')"
                        class="text-danger"
                        v-text="creating.form.errors.get('password')"
                      />
                    </div>
                    <div class="form-group">
                      <input
                        ...
                        @keydown="
                          creating.form.errors.clear('password_confirmation')
                        "
                      />
                      <span
                        v-if="
                          !$v.creating.form.password_confirmation.required &&
                          $v.creating.form.password_confirmation.$dirty
                        "
                        class="text-danger"
                      ...
                      <span
                        v-else-if="
                          !$v.creating.form.password_confirmation
                            .sameAsPassword &&
                          $v.creating.form.password_confirmation.$dirty
                        "
                        class="text-danger"
                      ...
                      >
                      <span
                        v-if="creating.form.errors.has('password_confirmation')"
                        class="text-danger"
                        v-text="
                          creating.form.errors.get('password_confirmation')
                        "
                      />
                    </div>
                    <div class="form-group">
                      ...
                      >
                        <div class="form-group">
                          <input
                            ...
                            :class="{
                              'is-invalid': editing.errors[column],
                            }"
                            class="form-control"
                          />
                          <span
...
export default {
  ...
  async asyncData({ $axios, params, app }) {
    const response = await $axios.get('admin/datatable/admin-user');
    return {
  ...
  data() {
    return {
      title: 'Admin Users',
      endpoint: 'admin/datatable/admin-user',
      creating: {
        active: false,
        form: new Form({
          name: null,
  ...
  methods: {
    ...
    async store() {
      ...
      if (!this.$v.$invalid) {
        try {
          await this.$axios
            .post('admin/register', this.creating.form)
            .then((response) => {
              if (response.data.data.message === 'success') {
                toastr.options = {
                  positionClass: 'toast-bottom-right',
                ...
                this.getRecords().then(() => {
                  ...
                  this.$v.$reset();
                  this.creating.form.reset();
                });
              }
            });
        } catch (error) {
          if (error.response.status === 422) {
            this.creating.form.errors.record(error.response.data);
          }
        }
      }
    },
    ...
    destroy(record) {
      ...
      this.$axios.delete(`${this.endpoint}/${record}`).then((response) => {
        if (response.data.data.message === 'success') {
          ...
          toastr.info('Admin deleted Successfully');
          this.getRecords();
